...
public class PlayerControllerWithJoypadSupport : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (!movementLocked)
        {
            if (controllerConnected)
            {
                ...
                playerTransform.position += new Vector3(horizontalMovement * speed * time, 0f, verticalMovement * speed * time);
